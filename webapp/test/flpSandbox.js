		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Card Sticker",
									"targetURL": "#zcardsticker-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcardsticker-display": {
								"semanticObject": "zcardsticker",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcardsticker",
									"url": sap.ui.require.toUrl("zcardsticker")
								}
							}
						}
					}
